...
定制Schema生成 (实体类型、关系类型、属性类型)
    ↓
三种分块策略 (GraphRAG:3000字符 | 向量:1500字符 | BM25:600字符)
    ↓
